...
(function() {
    ...
    var I = {
        ...
        'fp.wealth': '<polyline points="3 17 9 11 13 15 21 7"/><polyline points="15 7 21 7 21 13"/>',
        'fp.marriage': '<circle cx="9" cy="13" r="5"/><circle cx="15" cy="11" r="5"/>',
        'fp.travel': '<path d="M22 2 15 22l-4-9-9-4 20-7z"/><path d="M22 2 11 13"/>',
        'fp.emergency': '<path d="M12 3l8 3v6c0 4.5-3.4 7.8-8 9-4.6-1.2-8-4.5-8-9V6l8-3z"/><path d="M9 12l2 2 4-4"/>',
        'fp.business': '<path d="M5 4h14l2 5H3l2-5z"/><path d="M4 9v11h16V9"/><path d="M9.5 20v-5.5h5V20"/>',
        'fp.custom': '<path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z"/>',
        'fp.largecap': '<line x1="4" y1="20" x2="20" y2="20"/><rect x="5" y="12" width="3" height="6"/><rect x="10.5" y="7" width="3" height="11"/><rect x="16" y="10" width="3" height="8"/>',
        'fp.midcap': '<polyline points="3 17 9 11 13 15 21 7"/><polyline points="15 7 21 7 21 13"/>',
        'fp.smallcap': '<path d="M5 15c-1 1-1.4 4-1.4 4s3-.4 4-1.4"/><path d="M9 15l-3-3c1-4 4.5-8.5 9.5-9.5C16.5 7.5 13 12 9 15z"/><circle cx="14.5" cy="9.5" r="1.3"/>',
        'fp.elss': '<circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="4.5"/><circle cx="12" cy="12" r="1.2" fill="currentColor" stroke="none"/>',
        'fp.lock': '<rect x="5" y="11" width="14" height="9" rx="2"/><path d="M8 11V8a4 4 0 0 1 8 0v3"/>',
        'fp.nps': '<path d="M12 3l8 3v6c0 4.5-3.4 7.8-8 9-4.6-1.2-8-4.5-8-9V6l8-3z"/><path d="M9 12l2 2 4-4"/>',
        'fp.debt': '<path d="M3 9l9-6 9 6"/><line x1="4" y1="21" x2="20" y2="21"/><line x1="6" y1="21" x2="6" y2="12"/><line x1="12" y1="21" x2="12" y2="12"/><line x1="18" y1="21" x2="18" y2="12"/>',
        'fp.fd': '<path d="M3 9l9-6 9 6"/><line x1="4" y1="21" x2="20" y2="21"/><line x1="6" y1="21" x2="6" y2="12"/><line x1="12" y1="21" x2="12" y2="12"/><line x1="18" y1="21" x2="18" y2="12"/>',
        'fp.gold': '<path d="M8.5 10h7l1.2 4H7.3l1.2-4z"/><path d="M3.5 15h7l1.2 4H2.3l1.2-4z"/><path d="M13.5 15h7l1.2 4h-9.4l1.2-4z"/>',
        'fp.liquid': '<path d="M12 3s6 6.5 6 11a6 6 0 0 1-12 0c0-4.5 6-11 6-11z"/>',
        'fp.hybrid': '<circle cx="12" cy="12" r="9"/><path d="M12 3a9 9 0 0 1 0 18z" fill="currentColor" stroke="none"/>',
        'fp.epf': '<rect x="5" y="3" width="14" height="18" rx="1"/><path d="M9 7h0M15 7h0M9 11h0M15 11h0M9 15h0M15 15h0"/><path d="M10 21v-4h4v4"/>',
        'fp.stocks': '<polyline points="3 17 9 11 13 15 21 7"/><polyline points="15 7 21 7 21 13"/>',
        'fp.realestate': '<path d="M3 11l9-7 9 7"/><path d="M5 10v10h14V10"/><path d="M10 20v-5h4v5"/>',
        'fp.crypto': '<circle cx="12" cy="12" r="9"/><path d="M10 8h4a2 2 0 0 1 0 4h-4m0 0h4.5a2 2 0 0 1 0 4H10m0-8V6.5m0 11V16m2.5-9.5V6m0 12v-1.5"/>',
        'fp.senior': '<circle cx="12" cy="8" r="4"/><path d="M4 20a8 8 0 0 1 16 0"/>',
        'fp.mail': '<rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 7l9 6 9-6"/>',
        'fp.kvp': '<path d="M12 21V10"/><path d="M12 10c0-3 2-5.5 5.5-5.5 0 3-2.5 5.5-5.5 5.5z"/><path d="M12 13c0-3-2-5.5-5.5-5.5 0 3 2.5 5.5 5.5 5.5z"/>',
        'fp.rbi': '<path d="M3 9l9-6 9 6"/><line x1="4" y1="21" x2="20" y2="21"/><line x1="6" y1="21" x2="6" y2="12"/><line x1="12" y1="21" x2="12" y2="12"/><line x1="18" y1="21" x2="18" y2="12"/>',
        'fp.nsc': '<path d="M6 3h9l3 3v15H6z"/><path d="M9 9h6M9 13h6M9 17h4"/>',
        'fp.mf': '<line x1="4" y1="20" x2="20" y2="20"/><rect x="5" y="12" width="3" height="6"/><rect x="10.5" y="7" width="3" height="11"/><rect x="16" y="10" width="3" height="8"/>',
        'fp.check': '<circle cx="12" cy="12" r="9"/><path d="M8 12l3 3 5-5"/>',
        'fp.warn': '<path d="M12 4l9 16H3z"/><line x1="12" y1="10" x2="12" y2="14"/><circle cx="12" cy="17.3" r="1" fill="currentColor" stroke="none"/>',
        'fp.pie': '<path d="M12 3a9 9 0 1 0 9 9h-9V3z"/><path d="M14 3.2A9 9 0 0 1 20.8 10H14V3.2z"/>',
        'fp.sipbars': '<line x1="4" y1="20" x2="20" y2="20"/><rect x="5" y="12" width="3" height="6"/><rect x="10.5" y="7" width="3" height="11"/><rect x="16" y="10" width="3" height="8"/>',
        'fp.snap': '<rect x="5" y="4" width="14" height="17" rx="2"/><path d="M9 4a3 3 0 0 1 6 0"/><line x1="9" y1="11" x2="15" y2="11"/><line x1="9" y1="15" x2="15" y2="15"/>',
        'fp.roadmap': '<circle cx="6" cy="19" r="2"/><circle cx="18" cy="5" r="2"/><path d="M8 19h6a4 4 0 0 0 0-8H10a4 4 0 0 1 0-8h6"/>',
        'fp.redeem': '<path d="M3 9l9-6 9 6"/><line x1="4" y1="21" x2="20" y2="21"/><line x1="6" y1="21" x2="6" y2="12"/><line x1="12" y1="21" x2="12" y2="12"/><line x1="18" y1="21" x2="18" y2="12"/>',
        'fp.q1': '<polyline points="3 7 9 13 13 9 21 17"/><polyline points="15 17 21 17 21 11"/>',
        'fp.q2': '<rect x="3" y="8" width="18" height="12" rx="2"/><path d="M9 8V6a3 3 0 0 1 6 0v2"/><path d="M3 13h18"/>',
        'fp.q3': '<path d="M9 18h6"/><path d="M10 21h4"/><path d="M12 3a6 6 0 0 0-4 10.5c.7.7 1 1.5 1 2.5h6c0-1 .3-1.8 1-2.5A6 6 0 0 0 12 3z"/>',
        'fp.q4': '<circle cx="12" cy="12" r="9"/><path d="M12 7.5V12l3 2"/>',
        'fp.q5': '<line x1="4" y1="20" x2="20" y2="20"/><rect x="5" y="12" width="3" height="6"/><rect x="10.5" y="7" width="3" height="11"/><rect x="16" y="10" width="3" height="8"/>',
